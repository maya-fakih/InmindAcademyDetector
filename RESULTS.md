...
| yolo26s-small-coco-100-epochs | yolo26s-small-coco | 0.260 | 0.563 (epoch 100/100) | 9.95 M | 22.45 | Extended run from the 50-epoch checkpoint above; best result on this branch so far, though the val/test gap (0.563 vs 0.260) is now the widest of any run -- same warehouse-shortcut pattern as yolo26n-coco and frcnn-amir-recipe, worth a leak check before trusting the train-val number. |
